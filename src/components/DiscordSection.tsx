        ...
        <article className="max-w-4xl mx-auto text-center">
          ...
          <header className="mb-8">
            ...
            <h2 className="text-4xl md:text-5xl font-caprasimo mb-6">
              Join Us on <span className="text-accent-400">Discord</span>
            </h2>

            <p className="text-xl font-redhat text-gray-300 mb-12 max-w-2xl mx-auto">
          ...
          {/* Join Button */}
          <footer className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 inline-block">
            <a
